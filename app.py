...
# Add state for active tab, default to Tab 2
...
with tab2:
    ...
    if not edited_df.equals(display_df):
        ...
        # กลไกป้องกันการเด้ง: เมื่อมีการแก้ไขในตาราง ให้ตั้งค่าแท็บกลับไปที่ 2 
        st.session_state.active_tab_label = "2. บันทึกขั้นตอนการทำงาน"
    ...
    def save_log_data_callback():
        ...
        if response and response.get('status') == 'success':
            ...
            # กลไกป้องกันการเด้ง: บังคับให้ Streamlit กลับมาที่แท็บ 2 หลังจากการบันทึกและ RERUN
            st.session_state.active_tab_label = "2. บันทึกขั้นตอนการทำงาน" 
            ...
            st.session_state.edited_log = True
            # หากล้มเหลว ให้แท็บยังอยู่ที่ 2
            st.session_state.active_tab_label = "2. บันทึกขั้นตอนการทำงาน" 
